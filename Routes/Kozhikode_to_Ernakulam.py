...
driver.get('https://www.redbus.in/bus-tickets/kozhikode-to-ernakulam?fromCityId=74661&toCityId=216&fromCityName=Kozhikode&toCityName=Ernakulam&busType=Any&onward=21-Jan-2025')
...
df['route'] = 'Kozhikode_to_Ernakulam'


df.to_excel('Kozhikode_to_Ernakulam.xlsx')
