...
driver.get('https://www.redbus.in/bus-tickets/kozhikode-to-mysore?fromCityId=74661&toCityId=129&fromCityName=Calicut&toCityName=Mysore&busType=Any&srcCountry=IND&destCountry=null&onward=21-Jan-2025')
...
df['route'] = 'Kozhikode_to_Mysore'
df.to_excel('Kozhikode_to_Mysore.xlsx',index=False)
