...
driver.get('https://www.redbus.in/bus-tickets/kozhikode-to-bangalore?fromCityId=74661&toCityId=122&fromCityName=Kozhikode&toCityName=Bangalore&busType=Any&srcCountry=IND&destCountry=IND&onward=21-Jan-2025')
...
df['route'] = 'Kozhikode_to_Bangalore'
df.to_excel('Kozhikode_to_Bangalore.xlsx',index=False)
