...
driver.get('https://www.redbus.in/bus-tickets/kozhikode-to-thiruvananthapuram?fromCityId=74661&toCityId=71425&fromCityName=Kozhikode&toCityName=Trivandrum&busType=Any&srcCountry=IND&destCountry=IND&onward=21-Jan-2025')
...
df['route'] = 'Kozhikode to Thiruvananthapuram'
df.to_excel('Kozhikode_to_Thiruvananthapuram.xlsx',index=False)
