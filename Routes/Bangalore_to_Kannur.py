...
driver.get('https://www.redbus.in/bus-tickets/bangalore-to-kannur?fromCityId=122&toCityId=558&fromCityName=Bangalore&toCityName=Kannur%20(Kerala)&busType=Any&srcCountry=IND&destCountry=IND&onward=21-Jan-2025')
...
df['route'] = 'Bangalore_to_Kannur'


df.to_excel('Bangalore_to_Kannur.xlsx')
