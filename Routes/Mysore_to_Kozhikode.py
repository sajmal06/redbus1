...
driver.get('https://www.redbus.in/bus-tickets/mysore-to-kozhikode?fromCityId=129&toCityId=74661&fromCityName=Mysore&toCityName=Kozhikode&busType=Any&srcCountry=IND&destCountry=null&onward=21-Jan-2025')
...
df['route'] = 'Mysore to Kozhikode'
df.to_excel('Mysore_to_Kozhikode.xlsx',index=False)
