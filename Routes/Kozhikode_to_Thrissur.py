...
#page size and buses are higher so not able to fetch all the buses
...
driver.get('https://www.redbus.in/bus-tickets/kozhikode-to-thrissur?fromCityId=74661&toCityId=995&fromCityName=Kozhikode&toCityName=Thrissur&busType=Any&srcCountry=IND&destCountry=IND&onward=21-Jan-2025')
...
df['route'] = 'Kozhikode to Thrissur'
df.to_excel('Kozhikode_to_Thrissur.xlsx',index=False)
