...
driver.get('https://www.redbus.in/bus-tickets/bangalore-to-kozhikode?fromCityId=122&toCityId=74661&fromCityName=Bangalore&toCityName=Calicut&busType=Any&srcCountry=IND&destCountry=IND&onward=21-Jan-2025')
...
df['route'] = 'Bangalore_to_Kozhikode'
df.to_excel('Bangalore_to_Kozhikode.xlsx',index=False)
