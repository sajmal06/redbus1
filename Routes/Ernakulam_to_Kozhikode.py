...
driver.get('https://www.redbus.in/bus-tickets/ernakulam-to-kozhikode?fromCityId=216&toCityId=74661&fromCityName=Ernakulam&toCityName=Kozhikode&busType=Any&srcCountry=IND&destCountry=IND&onward=21-Jan-2025')
...
df['route'] = 'Ernakulam_to_Kozhikode'
df.to_excel('Ernakulam_to_Kozhikode.xlsx',index=False)
